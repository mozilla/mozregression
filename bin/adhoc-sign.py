...
def main(args: argparse.Namespace):
    ...
    for signing_format in signing_formats:
        ...
        params[signing_format]["requestor"] = "Zeid Zabaneh <zeid@mozilla.com>"
...
def create_parser():
    ...
    parser.add_argument("--bug", default="0000000", help="optional bug number to include")
    return parser
